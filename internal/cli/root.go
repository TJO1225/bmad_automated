...
type App struct {
	...
	// Defaults to [config.ModeBmad] when unset.
	Mode string
...
story creation, implementation, and code review.`,
	}
	...
	rootCmd.PersistentFlags().StringVar(&app.Mode, "mode", config.ModeBmad, "Pipeline mode: bmad (create-story -> dev-story -> code-review) or beads (create-story -> sync-to-beads)")
